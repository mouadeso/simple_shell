...
/**
 * find_builtin - Finds a builtin command and executes it if found.
 * @info: The parameter and return info struct.
 *
...
/**
 * find_cmd - Tries to find and execute a command in the PATH.
 * @info: The parameter and return info struct.
 *
 * Return: void
 */
...
/**
 * fork_cmd - Forks a new process and runs the given command.
 * @info: The parameter and return info struct.
 *
 * Return: void
 */
